...
--
WITH ADA.UNCHECKED_CONVERSION;WITH INTERFACES.C;WITH SYSTEM.ADDRESS_TO_ACCESS_CONVERSIONS;PACKAGE GL IS PACKAGE C RENAMES INTERFACES.C;
...
GL_TRUE:CONSTANT GL_BOOLEAN:=GL_BOOLEAN'VAL(1);TYPE GETPOINTERENM IS (FEEDBACK_BUFFER_POINTER,SELECTION_BUFFER_POINTER,VERTEX_ARRAY_POINTER,
NORMAL_ARRAY_POINTER,COLOR_ARRAY_POINTER,INDEX_ARRAY_POINTER,TEXTURE_COORD_ARRAY_POINTER,EDGE_FLAG_ARRAY_POINTER );FOR GETPOINTERENM USE
(FEEDBACK_BUFFER_POINTER=>16#0DF0#,SELECTION_BUFFER_POINTER=>16#0DF3#,VERTEX_ARRAY_POINTER=>16#808E#,NORMAL_ARRAY_POINTER=>16#808F#,COLOR_ARRAY_POINTER=>16#8090#,
INDEX_ARRAY_POINTER=>16#8091#,TEXTURE_COORD_ARRAY_POINTER=>16#8092#,EDGE_FLAG_ARRAY_POINTER=>16#8093# );FOR GETPOINTERENM'SIZE USE GL.ENUM'SIZE;
...
FUNC_SUBTRACT_EXT=>16#800A#,FUNC_REVERSE_SUBTRACT_EXT=>16#800B# );FOR BLENDEQUATIONENM'SIZE USE GL.ENUM'SIZE;PROCEDURE SET_BLEND_FUNC (SRC_FACTOR:BLENDSRCENM;
DST_FACTOR:BLENDDSTENM);PROCEDURE BLENDFUNC (SRC_FACTOR:BLENDSRCENM;DST_FACTOR:BLENDDSTENM)RENAMES SET_BLEND_FUNC;PRAGMA OBSOLESCENT(BLENDFUNC,"Prefer the new name, Set_Blend_Func");
PROCEDURE BLENDEQUATIONEXT(MODE:BLENDEQUATIONENM);PROCEDURE BLENDCOLOREXT(RED:GL.CLAMPF;GREEN:GL.CLAMPF;BLUE:GL.CLAMPF;ALPHA:GL.CLAMPF);
TYPE LOGICOPENM IS (CLEAR,GL_AND,AND_REVERSE,COPY,AND_INVERTED,NOOP,GL_XOR,GL_OR,NOR,EQUIV,INVERT,OR_REVERSE,COPY_INVERTED,OR_INVERTED,
NAND,SET );FOR LOGICOPENM USE (CLEAR=>16#1500#,GL_AND=>16#1501#,AND_REVERSE=>16#1502#,COPY=>16#1503#,AND_INVERTED=>16#1504#,NOOP=>16#1505#,
GL_XOR=>16#1506#,GL_OR=>16#1507#,NOR=>16#1508#,EQUIV=>16#1509#,INVERT=>16#150A#,OR_REVERSE=>16#150B#,COPY_INVERTED=>16#150C#,OR_INVERTED=>16#150D#,
NAND=>16#150E#,SET=>16#150F# );FOR LOGICOPENM'SIZE USE GL.ENUM'SIZE;PROCEDURE LOGICOP(OPCODE:LOGICOPENM);TYPE FACE_SELECTOR IS(FRONT,BACK,FRONT_AND_BACK);
SUBTYPE FACEENM IS FACE_SELECTOR;PRAGMA OBSOLESCENT(FACEENM,"Prefer the new name, Face_Selector");PROCEDURE SET_CULL_FACE(MODE:FACE_SELECTOR);
PROCEDURE CULLFACE(MODE:FACE_SELECTOR)RENAMES SET_CULL_FACE;PRAGMA OBSOLESCENT(CULLFACE,"Prefer the new name, Set_Cull_Face");TYPE ORIENTATION IS(CLOCKWISE,COUNTER_CLOCKWISE);
SUBTYPE ORIENTATIONENM IS ORIENTATION;PRAGMA OBSOLESCENT(ORIENTATIONENM,"Prefer the new name, Orientation");FUNCTION CW RETURN ORIENTATION;
PRAGMA OBSOLESCENT(CW,"Prefer the new name, Clockwise");FUNCTION CCW RETURN ORIENTATION;PRAGMA OBSOLESCENT(CCW,"Prefer the new name, Counter_Clockwise");
PROCEDURE SET_FRONT_FACE(MODE:ORIENTATION);PROCEDURE FRONTFACE(MODE:ORIENTATION)RENAMES SET_FRONT_FACE;PRAGMA OBSOLESCENT(FRONTFACE,"Prefer the new name, Set_Front_Face");
TYPE POLYGON_MODE_TYPE IS(POINT,LINE,FILL);SUBTYPE POLYGONMODEENM IS POLYGON_MODE_TYPE;PRAGMA OBSOLESCENT(POLYGONMODEENM,"Prefer the new name, Polygon_Mode_Type");
PROCEDURE SET_POLYGON_MODE(FACE:FACE_SELECTOR;MODE:POLYGON_MODE_TYPE);PROCEDURE POLYGONMODE(FACE:FACE_SELECTOR;MODE:POLYGON_MODE_TYPE)RENAMES SET_POLYGON_MODE;
PRAGMA OBSOLESCENT(POLYGONMODE,"Prefer the new name, Set_Polygon_Mode");TYPE CLIPPLANEENM IS (CLIP_PLANE0,CLIP_PLANE1,CLIP_PLANE2,CLIP_PLANE3,
CLIP_PLANE4,CLIP_PLANE5 );FOR CLIPPLANEENM USE (CLIP_PLANE0=>16#3000#,CLIP_PLANE1=>16#3001#,CLIP_PLANE2=>16#3002#,CLIP_PLANE3=>16#3003#,
CLIP_PLANE4=>16#3004#,CLIP_PLANE5=>16#3005# );FOR CLIPPLANEENM'SIZE USE GL.ENUM'SIZE;PROCEDURE CLIPPLANE(PLANE:CLIPPLANEENM;EQUATION:GL.DOUBLEPTR);
PROCEDURE GETCLIPPLANE(PLANE:CLIPPLANEENM;EQUATION:GL.DOUBLEPTR);TYPE DRAWBUFFERENM IS (NONE,FRONT_LEFT,FRONT_RIGHT,BACK_LEFT,BACK_RIGHT,
FRONT,BACK,LEFT,RIGHT,FRONT_AND_BACK,AUX0,AUX1,AUX2,AUX3 );FOR DRAWBUFFERENM USE (NONE=>16#0000#,FRONT_LEFT=>16#0400#,FRONT_RIGHT=>16#0401#,
BACK_LEFT=>16#0402#,BACK_RIGHT=>16#0403#,FRONT=>16#0404#,BACK=>16#0405#,LEFT=>16#0406#,RIGHT=>16#0407#,FRONT_AND_BACK=>16#0408#,AUX0=>16#0409#,
AUX1=>16#040A#,AUX2=>16#040B#,AUX3=>16#040C# );FOR DRAWBUFFERENM'SIZE USE GL.ENUM'SIZE;PROCEDURE DRAWBUFFER(MODE:DRAWBUFFERENM);TYPE READBUFFERENM IS
(FRONT_LEFT,FRONT_RIGHT,BACK_LEFT,BACK_RIGHT,FRONT,BACK,LEFT,RIGHT,AUX0,AUX1,AUX2,AUX3 );FOR READBUFFERENM USE (FRONT_LEFT=>16#0400#,FRONT_RIGHT=>16#0401#,
BACK_LEFT=>16#0402#,BACK_RIGHT=>16#0403#,FRONT=>16#0404#,BACK=>16#0405#,LEFT=>16#0406#,RIGHT=>16#0407#,AUX0=>16#0409#,AUX1=>16#040A#,AUX2=>16#040B#,
AUX3=>16#040C# );FOR READBUFFERENM'SIZE USE GL.ENUM'SIZE;PROCEDURE READBUFFER(MODE:READBUFFERENM);TYPE SERVERCAPABILITYENM IS (POINT_SMOOTH,
LINE_SMOOTH,LINE_STIPPLE,POLYGON_SMOOTH,POLYGON_STIPPLE,CULL_FACE,LIGHTING,COLOR_MATERIAL,FOG,DEPTH_TEST,STENCIL_TEST,NORMALIZE,ALPHA_TEST,
DITHER,BLEND,INDEX_LOGIC_OP,COLOR_LOGIC_OP,SCISSOR_TEST,TEXTURE_GEN_S,TEXTURE_GEN_T,TEXTURE_GEN_R,TEXTURE_GEN_Q,AUTO_NORMAL,MAP1_COLOR_4,
MAP1_INDEX,MAP1_NORMAL,MAP1_TEXTURE_COORD_1,MAP1_TEXTURE_COORD_2,MAP1_TEXTURE_COORD_3,MAP1_TEXTURE_COORD_4,MAP1_VERTEX_3,MAP1_VERTEX_4,
MAP2_COLOR_4,MAP2_INDEX,MAP2_NORMAL,MAP2_TEXTURE_COORD_1,MAP2_TEXTURE_COORD_2,MAP2_TEXTURE_COORD_3,MAP2_TEXTURE_COORD_4,MAP2_VERTEX_3,
MAP2_VERTEX_4,TEXTURE_1D,TEXTURE_2D,POLYGON_OFFSET_POINT,POLYGON_OFFSET_LINE,CLIP_PLANE0,CLIP_PLANE1,CLIP_PLANE2,CLIP_PLANE3,CLIP_PLANE4,
CLIP_PLANE5,LIGHT0,LIGHT1,LIGHT2,LIGHT3,LIGHT4,LIGHT5,LIGHT6,LIGHT7,POLYGON_OFFSET_FILL,TEXTURE_3D_EXT,MULTISAMPLE_ARB,SAMPLE_ALPHA_TO_COVERAGE_ARB,
...
MULT=>16#0103#,ADD=>16#0104# );FOR ACCUMENM'SIZE USE GL.ENUM'SIZE;PROCEDURE ACCUM(OP:ACCUMENM;VALUE:GL.FLOAT);TYPE MATRIX_MODE_TYPE IS(MODELVIEW,PROJECTION,TEXTURE,COLOR);
FOR MATRIX_MODE_TYPE USE (MODELVIEW=>16#1700#,PROJECTION=>16#1701#,TEXTURE=>16#1702#,COLOR=>16#1800#);FOR MATRIX_MODE_TYPE'SIZE USE GL.ENUM'SIZE;
SUBTYPE MATRIXMODEENM IS MATRIX_MODE_TYPE;PRAGMA OBSOLESCENT(MATRIXMODEENM,"Prefer the new name, Matrix_Mode_Type");PROCEDURE SET_MATRIX_MODE(MODE:MATRIX_MODE_TYPE);
PROCEDURE MATRIXMODE(MODE:MATRIX_MODE_TYPE)RENAMES SET_MATRIX_MODE;PRAGMA OBSOLESCENT(MATRIXMODE,"Prefer the new name, Set_Matrix_Mode");
TYPE LISTMODEENM IS (COMPILE,COMPILE_AND_EXECUTE );FOR LISTMODEENM USE (COMPILE=>16#1300#,COMPILE_AND_EXECUTE=>16#1301# );FOR LISTMODEENM'SIZE USE GL.ENUM'SIZE;
...
);FOR OFFSETTYPEENM USE (GL_BYTE=>16#1400#,GL_UNSIGNED_BYTE=>16#1401#,GL_SHORT=>16#1402#,GL_UNSIGNED_SHORT=>16#1403#,GL_INT=>16#1404#,
GL_UNSIGNED_INT=>16#1405#,GL_FLOAT=>16#1406#,GL_2_BYTES=>16#1407#,GL_3_BYTES=>16#1408#,GL_4_BYTES=>16#1409# );FOR OFFSETTYPEENM'SIZE USE GL.ENUM'SIZE;
FUNCTION ISLIST(LIST:GL.UINT)RETURN GL_BOOLEAN;PROCEDURE DELETE_LISTS(LIST:GL.UINT;C_RANGE:GL.SIZEI);PROCEDURE DELETELISTS(LIST:GL.UINT;
C_RANGE:GL.SIZEI)RENAMES DELETE_LISTS;PRAGMA OBSOLESCENT(DELETELISTS,"Prefer the new name, Delete_Lists");FUNCTION GEN_LISTS(C_RANGE:GL.SIZEI)RETURN GL.UINT;
FUNCTION GENLISTS(C_RANGE:GL.SIZEI)RETURN GL.UINT RENAMES GEN_LISTS;PRAGMA OBSOLESCENT(GENLISTS,"Prefer the new name, Gen_Lists");PROCEDURE NEW_LIST(LIST:GL.UINT;
MODE:LISTMODEENM);PROCEDURE NEWLIST(LIST:GL.UINT;MODE:LISTMODEENM)RENAMES NEW_LIST;PRAGMA OBSOLESCENT(NEWLIST,"Prefer the new name, New_List");
PROCEDURE END_LIST;PROCEDURE ENDLIST RENAMES END_LIST;PRAGMA OBSOLESCENT(ENDLIST,"Prefer the new name, End_List");PROCEDURE CALL_LIST(LIST:GL.UINT);
PROCEDURE CALLLIST(LIST:GL.UINT)RENAMES CALL_LIST;PRAGMA OBSOLESCENT(CALLLIST,"Prefer the new name, Call_List");PROCEDURE CALLLISTS(N:GL.SIZEI;
C_TYPE:OFFSETTYPEENM;LISTS:GL.POINTER);PROCEDURE LISTBASE(BASE:GL.UINT);TYPE OBJECTTYPEENM IS (POINTS,LINES,LINE_LOOP,LINE_STRIP,TRIANGLES,
TRIANGLE_STRIP,TRIANGLE_FAN,QUADS,QUAD_STRIP,POLYGON );FOR OBJECTTYPEENM USE (POINTS=>16#0000#,LINES=>16#0001#,LINE_LOOP=>16#0002#,LINE_STRIP=>16#0003#,
TRIANGLES=>16#0004#,TRIANGLE_STRIP=>16#0005#,TRIANGLE_FAN=>16#0006#,QUADS=>16#0007#,QUAD_STRIP=>16#0008#,POLYGON=>16#0009# );FOR OBJECTTYPEENM'SIZE USE GL.ENUM'SIZE;
...
COUNT:GL.SIZEI;C_TYPE:ARRAYINDEXTYPEENM;INDICES:GL.POINTER);PROCEDURE INTERLEAVEDARRAYS(FORMAT:INTERLEAVEFORMATENM;STRIDE:GL.SIZEI;PTR:GL.POINTER);
TYPE SHADE_MODEL_TYPE IS(FLAT,SMOOTH);SUBTYPE SHADEMODEENM IS SHADE_MODEL_TYPE;PRAGMA OBSOLESCENT(SHADEMODEENM,"Prefer the new name, Shade_Model_Type");
PROCEDURE SET_SHADE_MODEL(MODE:SHADE_MODEL_TYPE);PROCEDURE SHADEMODEL(MODE:SHADE_MODEL_TYPE)RENAMES SET_SHADE_MODEL;PRAGMA OBSOLESCENT(SHADEMODEL,"Prefer the new name, Set_Shade_Model");
...
);FOR LIGHTMODELVENM'SIZE USE GL.ENUM'SIZE;PROCEDURE LIGHT(LIGHT_ID:LIGHTIDENM;PNAME:LIGHTPARAMETERENM;PARAM:GL.FLOAT);PROCEDURE LIGHTI(LIGHT_ID:LIGHTIDENM;
PNAME:LIGHTPARAMETERENM;PARAM:GL.INT);PROCEDURE LIGHT(LIGHT_ID:LIGHTIDENM;PNAME:LIGHTPARAMETERVENM;PARAMS:LIGHT_FLOAT_VECTOR);PROCEDURE LIGHTIV(LIGHT_ID:LIGHTIDENM;
PNAME:LIGHTPARAMETERVENM;PARAMS:GL.INTPOINTER);PROCEDURE GETLIGHTFV(LIGHT_ID:LIGHTIDENM;PNAME:LIGHTPARAMETERVENM;PARAMS:FLOATPTR);PROCEDURE GETLIGHTIV(LIGHT_ID:LIGHTIDENM;
...
PROCEDURE MATERIAL(FACE:FACE_SELECTOR;PNAME:MATERIALPARAMETERENM;PARAM:GL.FLOAT);PROCEDURE MATERIALI(FACE:FACE_SELECTOR;PNAME:MATERIALPARAMETERENM;
PARAM:GL.INT);PROCEDURE MATERIAL(FACE:FACE_SELECTOR;PNAME:MATERIALPARAMETERVENM;PARAMS:MATERIAL_FLOAT_VECTOR);PROCEDURE MATERIALIV(FACE:FACE_SELECTOR;
PNAME:MATERIALPARAMETERVENM;PARAMS:GL.INTPOINTER);PROCEDURE GETMATERIALFV(FACE:FACE_SELECTOR;PNAME:GETMATERIALPARAMETERENM;PARAMS:FLOATPTR);
PROCEDURE GETMATERIALIV(FACE:FACE_SELECTOR;PNAME:GETMATERIALPARAMETERENM;PARAMS:GL.INTPOINTER);PROCEDURE COLORMATERIAL(FACE:FACE_SELECTOR;
MODE:COLORMATERIALENM);TYPE PIXELSTORAGEENM IS (UNPACK_SWAP_BYTES,UNPACK_LSB_FIRST,UNPACK_ROW_LENGTH,UNPACK_SKIP_ROWS,UNPACK_SKIP_PIXELS,
UNPACK_ALIGNMENT,PACK_SWAP_BYTES,PACK_LSB_FIRST,PACK_ROW_LENGTH,PACK_SKIP_ROWS,PACK_SKIP_PIXELS,PACK_ALIGNMENT );FOR PIXELSTORAGEENM USE
(UNPACK_SWAP_BYTES=>16#0CF0#,UNPACK_LSB_FIRST=>16#0CF1#,UNPACK_ROW_LENGTH=>16#0CF2#,UNPACK_SKIP_ROWS=>16#0CF3#,UNPACK_SKIP_PIXELS=>16#0CF4#,
UNPACK_ALIGNMENT=>16#0CF5#,PACK_SWAP_BYTES=>16#0D00#,PACK_LSB_FIRST=>16#0D01#,PACK_ROW_LENGTH=>16#0D02#,PACK_SKIP_ROWS=>16#0D03#,PACK_SKIP_PIXELS=>16#0D04#,
PACK_ALIGNMENT=>16#0D05# );FOR PIXELSTORAGEENM'SIZE USE GL.ENUM'SIZE;TYPE PIXELTRANSFERENM IS (MAP_COLOR,MAP_STENCIL,INDEX_SHIFT,INDEX_OFFSET,
RED_SCALE,RED_BIAS,GREEN_SCALE,GREEN_BIAS,BLUE_SCALE,BLUE_BIAS,ALPHA_SCALE,ALPHA_BIAS,DEPTH_SCALE,DEPTH_BIAS );FOR PIXELTRANSFERENM USE
(MAP_COLOR=>16#0D10#,MAP_STENCIL=>16#0D11#,INDEX_SHIFT=>16#0D12#,INDEX_OFFSET=>16#0D13#,RED_SCALE=>16#0D14#,RED_BIAS=>16#0D15#,GREEN_SCALE=>16#0D18#,
GREEN_BIAS=>16#0D19#,BLUE_SCALE=>16#0D1A#,BLUE_BIAS=>16#0D1B#,ALPHA_SCALE=>16#0D1C#,ALPHA_BIAS=>16#0D1D#,DEPTH_SCALE=>16#0D1E#,DEPTH_BIAS=>16#0D1F#
);FOR PIXELTRANSFERENM'SIZE USE GL.ENUM'SIZE;TYPE PIXELMAPENM IS (PIXEL_MAP_I_TO_I,PIXEL_MAP_S_TO_S,PIXEL_MAP_I_TO_R,PIXEL_MAP_I_TO_G,
PIXEL_MAP_I_TO_B,PIXEL_MAP_I_TO_A,PIXEL_MAP_R_TO_R,PIXEL_MAP_G_TO_G,PIXEL_MAP_B_TO_B,PIXEL_MAP_A_TO_A );FOR PIXELMAPENM USE (PIXEL_MAP_I_TO_I=>16#0C70#,
PIXEL_MAP_S_TO_S=>16#0C71#,PIXEL_MAP_I_TO_R=>16#0C72#,PIXEL_MAP_I_TO_G=>16#0C73#,PIXEL_MAP_I_TO_B=>16#0C74#,PIXEL_MAP_I_TO_A=>16#0C75#,
PIXEL_MAP_R_TO_R=>16#0C76#,PIXEL_MAP_G_TO_G=>16#0C77#,PIXEL_MAP_B_TO_B=>16#0C78#,PIXEL_MAP_A_TO_A=>16#0C79# );FOR PIXELMAPENM'SIZE USE GL.ENUM'SIZE;
TYPE PIXELFORMATENM IS (COLOR_INDEX,STENCIL_INDEX,DEPTH_COMPONENT,RED,GREEN,BLUE,ALPHA,RGB,RGBA,LUMINANCE,LUMINANCE_ALPHA,BGR,BGRA );FOR PIXELFORMATENM USE
(COLOR_INDEX=>16#1900#,STENCIL_INDEX=>16#1901#,DEPTH_COMPONENT=>16#1902#,RED=>16#1903#,GREEN=>16#1904#,BLUE=>16#1905#,ALPHA=>16#1906#,
RGB=>16#1907#,RGBA=>16#1908#,LUMINANCE=>16#1909#,LUMINANCE_ALPHA=>16#190A#,BGR=>16#80E0#,BGRA=>16#80E1# );FOR PIXELFORMATENM'SIZE USE GL.ENUM'SIZE;
TYPE PIXELDATATYPEENM IS (GL_BYTE,GL_UNSIGNED_BYTE,GL_SHORT,GL_UNSIGNED_SHORT,GL_INT,GL_UNSIGNED_INT,GL_FLOAT,GL_BITMAP );FOR PIXELDATATYPEENM USE
(GL_BYTE=>16#1400#,GL_UNSIGNED_BYTE=>16#1401#,GL_SHORT=>16#1402#,GL_UNSIGNED_SHORT=>16#1403#,GL_INT=>16#1404#,GL_UNSIGNED_INT=>16#1405#,
GL_FLOAT=>16#1406#,GL_BITMAP=>16#1A00# );FOR PIXELDATATYPEENM'SIZE USE GL.ENUM'SIZE;TYPE PIXELCOPYTYPEENM IS (COLOR,DEPTH,STENCIL );FOR PIXELCOPYTYPEENM USE
(COLOR=>16#1800#,DEPTH=>16#1801#,STENCIL=>16#1802# );FOR PIXELCOPYTYPEENM'SIZE USE GL.ENUM'SIZE;PROCEDURE PIXELZOOM(XFACTOR:GL.FLOAT;YFACTOR:GL.FLOAT);
PROCEDURE PIXELSTOREF(PNAME:PIXELSTORAGEENM;PARAM:GL.FLOAT);PROCEDURE PIXELSTORE(PNAME:PIXELSTORAGEENM;PARAM:GL.INT);PROCEDURE PIXELTRANSFERF(PNAME:PIXELTRANSFERENM;
PARAM:GL.FLOAT);PROCEDURE PIXELTRANSFERI(PNAME:PIXELTRANSFERENM;PARAM:GL.INT);PROCEDURE PIXELMAPFV(MAP:PIXELMAPENM;MAPSIZE:GL.INT;VALUES:FLOATPTR);
PROCEDURE PIXELMAPUIV(MAP:PIXELMAPENM;MAPSIZE:GL.INT;VALUES:GL.UINTPTR);PROCEDURE PIXELMAPUSV(MAP:PIXELMAPENM;MAPSIZE:GL.INT;VALUES:USHORTPTR);
PROCEDURE GETPIXELMAPFV(MAP:PIXELMAPENM;VALUES:FLOATPTR);PROCEDURE GETPIXELMAPUIV(MAP:PIXELMAPENM;VALUES:GL.UINTPTR);PROCEDURE GETPIXELMAPUSV(MAP:PIXELMAPENM;
VALUES:USHORTPTR);PROCEDURE READPIXELS(X:GL.INT;Y:GL.INT;WIDTH:GL.SIZEI;HEIGHT:GL.SIZEI;FORMAT:PIXELFORMATENM;C_TYPE:PIXELDATATYPEENM;
PIXELS:GL.POINTER);PROCEDURE DRAWPIXELS(WIDTH:GL.SIZEI;HEIGHT:GL.SIZEI;FORMAT:PIXELFORMATENM;C_TYPE:PIXELDATATYPEENM;PIXELS:GL.POINTER);
PROCEDURE COPYPIXELS(X:GL.INT;Y:GL.INT;WIDTH:GL.SIZEI;HEIGHT:GL.SIZEI;C_TYPE:PIXELCOPYTYPEENM);TYPE TEXCOORDENM IS (S,T,R,Q );FOR TEXCOORDENM USE
(S=>16#2000#,T=>16#2001#,R=>16#2002#,Q=>16#2003# );FOR TEXCOORDENM'SIZE USE GL.ENUM'SIZE;TYPE TEXPARAMETERENM IS (TEXTURE_GEN_MODE );FOR TEXPARAMETERENM USE
(TEXTURE_GEN_MODE=>16#2500# );FOR TEXPARAMETERENM'SIZE USE GL.ENUM'SIZE;TYPE TEXPARAMETERVENM IS (TEXTURE_GEN_MODE,OBJECT_PLANE,EYE_PLANE
);FOR TEXPARAMETERVENM USE (TEXTURE_GEN_MODE=>16#2500#,OBJECT_PLANE=>16#2501#,EYE_PLANE=>16#2502# );FOR TEXPARAMETERVENM'SIZE USE GL.ENUM'SIZE;
TYPE TEXENVENM IS (TEXTURE_ENV );FOR TEXENVENM USE (TEXTURE_ENV=>16#2300# );FOR TEXENVENM'SIZE USE GL.ENUM'SIZE;TYPE TEXENVPARAMETERENM IS
(TEXTURE_ENV_MODE );FOR TEXENVPARAMETERENM USE (TEXTURE_ENV_MODE=>16#2200# );FOR TEXENVPARAMETERENM'SIZE USE GL.ENUM'SIZE;TYPE TEXENVPARAMETERVENM IS
(TEXTURE_ENV_MODE,TEXTURE_ENV_COLOR );FOR TEXENVPARAMETERVENM USE (TEXTURE_ENV_MODE=>16#2200#,TEXTURE_ENV_COLOR=>16#2201# );FOR TEXENVPARAMETERVENM'SIZE USE GL.ENUM'SIZE;
TYPE TARGETTEXENM IS (TEXTURE_1D,TEXTURE_2D );FOR TARGETTEXENM USE (TEXTURE_1D=>16#0DE0#,TEXTURE_2D=>16#0DE1# );FOR TARGETTEXENM'SIZE USE GL.ENUM'SIZE;
TYPE TEXPARAMENM IS (TEXTURE_MAG_FILTER,TEXTURE_MIN_FILTER,TEXTURE_WRAP_S,TEXTURE_WRAP_T,TEXTURE_PRIORITY );FOR TEXPARAMENM USE (TEXTURE_MAG_FILTER=>16#2800#,
...
PNAME:TEXPARAMENM;PARAM:GL.FLOAT);PROCEDURE TEXTURE_PARAMETER (TARGET:TARGETTEXENM;PNAME:TEXPARAMENM;PARAM:GL.INT);PROCEDURE TEXPARAMETER
(TARGET:TARGETTEXENM;PNAME:TEXPARAMENM;PARAM:GL.INT)RENAMES TEXTURE_PARAMETER;PRAGMA OBSOLESCENT(TEXPARAMETER,"Prefer the new name, Texture_Parameter");
PROCEDURE TEXPARAMETERFV(TARGET:TARGETTEXENM;PNAME:TEXPARAMVENM;PARAMS:FLOATPTR);PROCEDURE TEXPARAMETERIV(TARGET:TARGETTEXENM;PNAME:TEXPARAMVENM;
PARAMS:GL.INTPOINTER);PROCEDURE GETTEXPARAMETERFV(TARGET:TARGETTEXENM;PNAME:GETTEXPARAMENM;PARAMS:FLOATPTR);PROCEDURE GETTEXPARAMETERIV(TARGET:TARGETTEXENM;
PNAME:GETTEXPARAMENM;PARAMS:GL.INTPOINTER);PROCEDURE GETTEXLEVELPARAMETERFV(TARGET:TARGETTEXLEVELENM;LEVEL:GL.INT;PNAME:TEXLEVELPARAMETERENM;
PARAMS:FLOATPTR);PROCEDURE GETTEXLEVELPARAMETERIV(TARGET:TARGETTEXLEVELENM;LEVEL:GL.INT;PNAME:TEXLEVELPARAMETERENM;PARAMS:GL.INTPOINTER);
PROCEDURE TEXIMAGE1D(TARGET:TARGETTEX1DENM;LEVEL:GL.INT;INTERNALFORMAT:TEXFORMATENM;WIDTH:GL.SIZEI;BORDER:GL.INT;FORMAT:TEXPIXELFORMATENM;
C_TYPE:PIXELDATATYPEENM;PIXELS:GL.POINTER);PROCEDURE TEXIMAGE2D(TARGET:TARGETTEX2DENM;LEVEL:GL.INT;INTERNALFORMAT:TEXFORMATENM;WIDTH:GL.SIZEI;
HEIGHT:GL.SIZEI;BORDER:GL.INT;FORMAT:TEXPIXELFORMATENM;C_TYPE:PIXELDATATYPEENM;PIXELS:GL.POINTER);PROCEDURE GETTEXIMAGE(TARGET:TARGETTEXENM;
...
PROCEDURE DELETETEXTURES(N:GL.SIZEI;TEXTURES:GL.UINTPTR);PROCEDURE BIND_TEXTURE(TARGET:TARGETTEXENM;TEXTURE_ID:GL.UINT);PROCEDURE BINDTEXTURE(TARGET:TARGETTEXENM;
TEXTURE_ID:GL.UINT)RENAMES BIND_TEXTURE;PRAGMA OBSOLESCENT(BINDTEXTURE,"Prefer the new name, Bind_Texture");PROCEDURE PRIORITIZETEXTURES(N:GL.SIZEI;
...
FUNCTION ISTEXTURE(TEXTURE_ID:GL.UINT)RETURN GL_BOOLEAN;PROCEDURE TEXSUBIMAGE1D(TARGET:TARGETTEX1DONLYENM;LEVEL:GL.INT;XOFFSET:GL.INT;
WIDTH:GL.SIZEI;FORMAT:TEXPIXELFORMATENM;C_TYPE:PIXELDATATYPEENM;PIXELS:GL.POINTER);PROCEDURE TEXSUBIMAGE2D(TARGET:TARGETTEX2DONLYENM;LEVEL:GL.INT;
XOFFSET:GL.INT;YOFFSET:GL.INT;WIDTH:GL.SIZEI;HEIGHT:GL.SIZEI;FORMAT:TEXPIXELFORMATENM;C_TYPE:PIXELDATATYPEENM;PIXELS:GL.POINTER);PROCEDURE COPYTEXIMAGE1D(TARGET:TARGETTEX1DONLYENM;
...
WIDTH:GL.SIZEI;HEIGHT:GL.SIZEI;DEPTH_VALUE:GL.SIZEI;BORDER:GL.INT;FORMAT:TEXPIXELFORMATENM;C_TYPE:PIXELDATATYPEENM;PIXELS:GL.POINTER);
PROCEDURE TEXSUBIMAGE3DEXT(TARGET:TARGETTEX3DONLYENM;LEVEL:GL.INT;XOFFSET:GL.INT;YOFFSET:GL.INT;ZOFFSET:GL.INT;WIDTH:GL.SIZEI;HEIGHT:GL.SIZEI;
DEPTH_VALUE:GL.SIZEI;FORMAT:TEXPIXELFORMATENM;C_TYPE:PIXELDATATYPEENM;PIXELS:GL.POINTER);PROCEDURE COPYTEXSUBIMAGE3DEXT(TARGET:TARGETTEX3DONLYENM;
LEVEL:GL.INT;XOFFSET:GL.INT;YOFFSET:GL.INT;ZOFFSET:GL.INT;X:GL.INT;Y:GL.INT;WIDTH:GL.SIZEI;HEIGHT:GL.SIZEI);TYPE MAP1TARGETENM IS (MAP1_COLOR_4,
MAP1_INDEX,MAP1_NORMAL,MAP1_TEXTURE_COORD_1,MAP1_TEXTURE_COORD_2,MAP1_TEXTURE_COORD_3,MAP1_TEXTURE_COORD_4,MAP1_VERTEX_3,MAP1_VERTEX_4
);FOR MAP1TARGETENM USE (MAP1_COLOR_4=>16#0D90#,MAP1_INDEX=>16#0D91#,MAP1_NORMAL=>16#0D92#,MAP1_TEXTURE_COORD_1=>16#0D93#,MAP1_TEXTURE_COORD_2=>16#0D94#,
MAP1_TEXTURE_COORD_3=>16#0D95#,MAP1_TEXTURE_COORD_4=>16#0D96#,MAP1_VERTEX_3=>16#0D97#,MAP1_VERTEX_4=>16#0D98# );FOR MAP1TARGETENM'SIZE USE GL.ENUM'SIZE;
TYPE MAP2TARGETENM IS (MAP2_COLOR_4,MAP2_INDEX,MAP2_NORMAL,MAP2_TEXTURE_COORD_1,MAP2_TEXTURE_COORD_2,MAP2_TEXTURE_COORD_3,MAP2_TEXTURE_COORD_4,
MAP2_VERTEX_3,MAP2_VERTEX_4 );FOR MAP2TARGETENM USE (MAP2_COLOR_4=>16#0DB0#,MAP2_INDEX=>16#0DB1#,MAP2_NORMAL=>16#0DB2#,MAP2_TEXTURE_COORD_1=>16#0DB3#,
MAP2_TEXTURE_COORD_2=>16#0DB4#,MAP2_TEXTURE_COORD_3=>16#0DB5#,MAP2_TEXTURE_COORD_4=>16#0DB6#,MAP2_VERTEX_3=>16#0DB7#,MAP2_VERTEX_4=>16#0DB8#
);FOR MAP2TARGETENM'SIZE USE GL.ENUM'SIZE;TYPE MAPTARGETENM IS (MAP1_COLOR_4,MAP1_INDEX,MAP1_NORMAL,MAP1_TEXTURE_COORD_1,MAP1_TEXTURE_COORD_2,
MAP1_TEXTURE_COORD_3,MAP1_TEXTURE_COORD_4,MAP1_VERTEX_3,MAP1_VERTEX_4,MAP2_COLOR_4,MAP2_INDEX,MAP2_NORMAL,MAP2_TEXTURE_COORD_1,MAP2_TEXTURE_COORD_2,
MAP2_TEXTURE_COORD_3,MAP2_TEXTURE_COORD_4,MAP2_VERTEX_3,MAP2_VERTEX_4 );FOR MAPTARGETENM USE (MAP1_COLOR_4=>16#0D90#,MAP1_INDEX=>16#0D91#,
MAP1_NORMAL=>16#0D92#,MAP1_TEXTURE_COORD_1=>16#0D93#,MAP1_TEXTURE_COORD_2=>16#0D94#,MAP1_TEXTURE_COORD_3=>16#0D95#,MAP1_TEXTURE_COORD_4=>16#0D96#,
MAP1_VERTEX_3=>16#0D97#,MAP1_VERTEX_4=>16#0D98#,MAP2_COLOR_4=>16#0DB0#,MAP2_INDEX=>16#0DB1#,MAP2_NORMAL=>16#0DB2#,MAP2_TEXTURE_COORD_1=>16#0DB3#,
MAP2_TEXTURE_COORD_2=>16#0DB4#,MAP2_TEXTURE_COORD_3=>16#0DB5#,MAP2_TEXTURE_COORD_4=>16#0DB6#,MAP2_VERTEX_3=>16#0DB7#,MAP2_VERTEX_4=>16#0DB8#
);FOR MAPTARGETENM'SIZE USE GL.ENUM'SIZE;TYPE MAPQUERYENM IS (COEFF,ORDER,DOMAIN );FOR MAPQUERYENM USE (COEFF=>16#0A00#,ORDER=>16#0A01#,
DOMAIN=>16#0A02# );FOR MAPQUERYENM'SIZE USE GL.ENUM'SIZE;TYPE MESH1MODEENM IS (POINT,LINE );FOR MESH1MODEENM USE (POINT=>16#1B00#,LINE=>16#1B01#
);FOR MESH1MODEENM'SIZE USE GL.ENUM'SIZE;TYPE MESH2MODEENM IS (POINT,LINE,FILL );FOR MESH2MODEENM USE (POINT=>16#1B00#,LINE=>16#1B01#,
FILL=>16#1B02# );FOR MESH2MODEENM'SIZE USE GL.ENUM'SIZE;PROCEDURE MAP1D(TARGET:MAP1TARGETENM;U1:GL.DOUBLE;U2:GL.DOUBLE;STRIDE:GL.INT;ORDER_VALUE:GL.INT;
POINT_LIST:GL.DOUBLEPTR);PROCEDURE MAP1F(TARGET:MAP1TARGETENM;U1:GL.FLOAT;U2:GL.FLOAT;STRIDE:GL.INT;ORDER_VALUE:GL.INT;POINT_LIST:FLOATPTR);
PROCEDURE MAP2D(TARGET:MAP2TARGETENM;U1:GL.DOUBLE;U2:GL.DOUBLE;USTRIDE:GL.INT;UORDER:GL.INT;V1:GL.DOUBLE;V2:GL.DOUBLE;VSTRIDE:GL.INT;VORDER:GL.INT;
POINT_LIST:GL.DOUBLEPTR);PROCEDURE MAP2F(TARGET:MAP2TARGETENM;U1:GL.FLOAT;U2:GL.FLOAT;USTRIDE:GL.INT;UORDER:GL.INT;V1:GL.FLOAT;V2:GL.FLOAT;
VSTRIDE:GL.INT;VORDER:GL.INT;POINT_LIST:FLOATPTR);PROCEDURE GETMAPDV(TARGET:MAPTARGETENM;QUERY:MAPQUERYENM;V:GL.DOUBLEPTR);PROCEDURE GETMAPFV(TARGET:MAPTARGETENM;
QUERY:MAPQUERYENM;V:FLOATPTR);PROCEDURE GETMAPIV(TARGET:MAPTARGETENM;QUERY:MAPQUERYENM;V:GL.INTPOINTER);PROCEDURE EVALPOINT1(I:GL.INT);
PROCEDURE EVALPOINT2(I:GL.INT;J:GL.INT);PROCEDURE EVALMESH1(MODE:MESH1MODEENM;I1:GL.INT;I2:GL.INT);PROCEDURE EVALMESH2(MODE:MESH2MODEENM;
I1:GL.INT;I2:GL.INT;J1:GL.INT;J2:GL.INT);PROCEDURE EVALCOORD1D(U:GL.DOUBLE);PROCEDURE EVALCOORD1F(U:GL.FLOAT);PROCEDURE EVALCOORD1DV(U:GL.DOUBLEPTR);
PROCEDURE EVALCOORD1FV(U:FLOATPTR);PROCEDURE EVALCOORD2D(U:GL.DOUBLE;V:GL.DOUBLE);PROCEDURE EVALCOORD2F(U:GL.FLOAT;V:GL.FLOAT);PROCEDURE EVALCOORD2DV(U:GL.DOUBLEPTR);
PROCEDURE EVALCOORD2FV(U:FLOATPTR);PROCEDURE MAPGRID1D(UN:GL.INT;U1:GL.DOUBLE;U2:GL.DOUBLE);PROCEDURE MAPGRID1F(UN:GL.INT;U1:GL.FLOAT;
U2:GL.FLOAT);PROCEDURE MAPGRID2D(UN:GL.INT;U1:GL.DOUBLE;U2:GL.DOUBLE;VN:GL.INT;V1:GL.DOUBLE;V2:GL.DOUBLE);PROCEDURE MAPGRID2F(UN:GL.INT;
U1:GL.FLOAT;U2:GL.FLOAT;VN:GL.INT;V1:GL.FLOAT;V2:GL.FLOAT);TYPE FOGPARAMETERENM IS (FOG_INDEX,FOG_DENSITY,FOG_START,FOG_END,FOG_MODE );
FOR FOGPARAMETERENM USE (FOG_INDEX=>16#0B61#,FOG_DENSITY=>16#0B62#,FOG_START=>16#0B63#,FOG_END=>16#0B64#,FOG_MODE=>16#0B65# );FOR FOGPARAMETERENM'SIZE USE GL.ENUM'SIZE;
TYPE FOGPARAMETERVENM IS (FOG_INDEX,FOG_DENSITY,FOG_START,FOG_END,FOG_MODE,FOG_COLOR );FOR FOGPARAMETERVENM USE (FOG_INDEX=>16#0B61#,FOG_DENSITY=>16#0B62#,
FOG_START=>16#0B63#,FOG_END=>16#0B64#,FOG_MODE=>16#0B65#,FOG_COLOR=>16#0B66# );FOR FOGPARAMETERVENM'SIZE USE GL.ENUM'SIZE;LINEAR:CONSTANT:=16#2601#;
EXP1:CONSTANT:=16#0800#;EXP2:CONSTANT:=16#0801#;PROCEDURE FOGF(PNAME:FOGPARAMETERENM;PARAM:GL.FLOAT);PROCEDURE FOG(PNAME:FOGPARAMETERENM;
PARAM:GL.FLOAT)RENAMES FOGF;PROCEDURE FOGI(PNAME:FOGPARAMETERENM;PARAM:GL.INT);PROCEDURE FOG(PNAME:FOGPARAMETERENM;PARAM:GL.INT)RENAMES FOGI;
PROCEDURE FOGFV(PNAME:FOGPARAMETERVENM;PARAMS:FLOATPTR);PROCEDURE FOG(PNAME:FOGPARAMETERVENM;PARAMS:FLOATPTR)RENAMES FOGFV;PROCEDURE FOGIV(PNAME:FOGPARAMETERVENM;
PARAMS:GL.INTPOINTER);PROCEDURE FOG(PNAME:FOGPARAMETERVENM;PARAMS:GL.INTPOINTER)RENAMES FOGIV;TYPE FEEDBACKMODEENM IS (GL_2D,GL_3D,GL_3D_COLOR,
GL_3D_COLOR_TEXTURE,GL_4D_COLOR_TEXTURE );FOR FEEDBACKMODEENM USE (GL_2D=>16#0600#,GL_3D=>16#0601#,GL_3D_COLOR=>16#0602#,GL_3D_COLOR_TEXTURE=>16#0603#,
GL_4D_COLOR_TEXTURE=>16#0604# );FOR FEEDBACKMODEENM'SIZE USE GL.ENUM'SIZE;POINT_TOKEN:CONSTANT:=16#0701#;LINE_TOKEN:CONSTANT:=16#0702#;
LINE_RESET_TOKEN:CONSTANT:=16#0707#;POLYGON_TOKEN:CONSTANT:=16#0703#;BITMAP_TOKEN:CONSTANT:=16#0704#;DRAW_PIXEL_TOKEN:CONSTANT:=16#0705#;
COPY_PIXEL_TOKEN:CONSTANT:=16#0706#;PASS_THROUGH_TOKEN:CONSTANT:=16#0700#;FEEDBACK_BUFFER_SIZE:CONSTANT:=16#0DF1#;FEEDBACK_BUFFER_TYPE:CONSTANT:=16#0DF2#;
PROCEDURE FEEDBACKBUFFER(SIZE:GL.SIZEI;C_TYPE:FEEDBACKMODEENM;BUFFER:FLOATPTR);PROCEDURE PASSTHROUGH(TOKEN:GL.FLOAT);TYPE COLORTABLETARGETENM IS
(TEXTURE_1D,TEXTURE_2D,PROXY_TEXTURE_1D,PROXY_TEXTURE_2D,TEXTURE_3D_EXT,PROXY_TEXTURE_3D_EXT,SHARED_TEXTURE_PALETTE_EXT );FOR COLORTABLETARGETENM USE
(TEXTURE_1D=>16#0DE0#,TEXTURE_2D=>16#0DE1#,PROXY_TEXTURE_1D=>16#8063#,PROXY_TEXTURE_2D=>16#8064#,TEXTURE_3D_EXT=>16#806F#,PROXY_TEXTURE_3D_EXT=>16#8070#,
SHARED_TEXTURE_PALETTE_EXT=>16#81FB# );FOR COLORTABLETARGETENM'SIZE USE GL.ENUM'SIZE;TYPE GETCOLORTABLETARGETENM IS (TEXTURE_1D,TEXTURE_2D,
TEXTURE_3D_EXT,SHARED_TEXTURE_PALETTE_EXT );FOR GETCOLORTABLETARGETENM USE (TEXTURE_1D=>16#0DE0#,TEXTURE_2D=>16#0DE1#,TEXTURE_3D_EXT=>16#806F#,
SHARED_TEXTURE_PALETTE_EXT=>16#81FB# );FOR GETCOLORTABLETARGETENM'SIZE USE GL.ENUM'SIZE;TYPE COLORTABLEPARAMETERENM IS (COLOR_TABLE_FORMAT_EXT,
COLOR_TABLE_WIDTH_EXT,COLOR_TABLE_RED_SIZE_EXT,COLOR_TABLE_GREEN_SIZE_EXT,COLOR_TABLE_BLUE_SIZE_EXT,COLOR_TABLE_ALPHA_SIZE_EXT,COLOR_TABLE_LUMINANCE_SIZE_EXT,
COLOR_TABLE_INTENSITY_SIZE_EXT );FOR COLORTABLEPARAMETERENM USE (COLOR_TABLE_FORMAT_EXT=>16#80D8#,COLOR_TABLE_WIDTH_EXT=>16#80D9#,COLOR_TABLE_RED_SIZE_EXT=>16#80DA#,
...
PARAMS:FLOATPTR);PROCEDURE CLEARINDEX(C:GL.FLOAT);PROCEDURE CLEAR_COLOR(RED_VALUE:GL.CLAMPF;GREEN_VALUE:GL.CLAMPF;BLUE_VALUE:GL.CLAMPF;
ALPHA_VALUE:GL.CLAMPF);PROCEDURE CLEARCOLOR(RED_VALUE:GL.CLAMPF;GREEN_VALUE:GL.CLAMPF;BLUE_VALUE:GL.CLAMPF;ALPHA_VALUE:GL.CLAMPF)RENAMES CLEAR_COLOR;
PRAGMA OBSOLESCENT(CLEARCOLOR,"Prefer the new name, Clear_Color");PROCEDURE CLEAR(MASK:BITFIELD);PROCEDURE CLEARDEPTH(DEPTH_VALUE:GL.CLAMPD);
PROCEDURE CLEAR_ACCUMULATION_BUFFER (RED_VALUE:GL.FLOAT;GREEN_VALUE:GL.FLOAT;BLUE_VALUE:GL.FLOAT;ALPHA_VALUE:GL.FLOAT);PROCEDURE CLEARACCUM(RED_VALUE:GL.FLOAT;
GREEN_VALUE:GL.FLOAT;BLUE_VALUE:GL.FLOAT;ALPHA_VALUE:GL.FLOAT)RENAMES CLEAR_ACCUMULATION_BUFFER;PRAGMA OBSOLESCENT(CLEARACCUM,"Prefer the new name, Clear_Accumulation_Buffer");
PROCEDURE INDEXMASK(MASK:GL.UINT);PROCEDURE COLORMASK(RED_VALUE:GL_BOOLEAN;GREEN_VALUE:GL_BOOLEAN;BLUE_VALUE:GL_BOOLEAN;ALPHA_VALUE:GL_BOOLEAN);
PROCEDURE POINTSIZE(SIZE:GL.FLOAT);PROCEDURE LINEWIDTH(WIDTH:GL.FLOAT);PROCEDURE LINESTIPPLE(FACTOR:GL.INT;PATTERN:GL.USHORT);PROCEDURE POLYGONOFFSET(FACTOR:GL.FLOAT;
UNITS:GL.FLOAT);PROCEDURE POLYGONSTIPPLE(MASK:UBYTEPTR);PROCEDURE GETPOLYGONSTIPPLE(MASK:UBYTEPTR);PROCEDURE EDGEFLAG(FLAG:GL_BOOLEAN);
PROCEDURE EDGEFLAGV(FLAG:GL_BOOLEANPTR);PROCEDURE SCISSOR(X:GL.INT;Y:GL.INT;WIDTH:GL.SIZEI;HEIGHT:GL.SIZEI);PROCEDURE PUSH_ATTRIB(MASK:BITFIELD);
PROCEDURE PUSHATTRIB(MASK:BITFIELD)RENAMES PUSH_ATTRIB;PRAGMA OBSOLESCENT(PUSHATTRIB,"Prefer the new name, Push_Attrib");PROCEDURE POP_ATTRIB;
PROCEDURE POPATTRIB RENAMES POP_ATTRIB;PRAGMA OBSOLESCENT(POPATTRIB,"Prefer the new name, Pop_Attrib");PROCEDURE PUSHCLIENTATTRIB(MASK:BITFIELD);
...
FAR_VAL:GL.CLAMPD);PROCEDURE ORTHO(LEFT_VAL:GL.DOUBLE;RIGHT_VAL:GL.DOUBLE;BOTTOM_VAL:GL.DOUBLE;TOP_VAL:GL.DOUBLE;NEAR_VAL:GL.DOUBLE;FAR_VAL:GL.DOUBLE);
PROCEDURE FRUSTUM(LEFT_VAL:GL.DOUBLE;RIGHT_VAL:GL.DOUBLE;BOTTOM_VAL:GL.DOUBLE;TOP_VAL:GL.DOUBLE;NEAR_VAL:GL.DOUBLE;FAR_VAL:GL.DOUBLE);
PROCEDURE VIEWPORT(X:GL.INT;Y:GL.INT;WIDTH:GL.SIZEI;HEIGHT:GL.SIZEI);PROCEDURE PUSH_MATRIX;PROCEDURE PUSHMATRIX RENAMES PUSH_MATRIX;PRAGMA OBSOLESCENT(PUSHMATRIX,"Prefer the new name, Push_Matrix");
PROCEDURE POP_MATRIX;PROCEDURE POPMATRIX RENAMES POP_MATRIX;PRAGMA OBSOLESCENT(POPMATRIX,"Prefer the new name, Pop_Matrix");PROCEDURE LOAD_IDENTITY;
PROCEDURE LOADIDENTITY RENAMES LOAD_IDENTITY;PRAGMA OBSOLESCENT(LOADIDENTITY,"Prefer the new name, Load_Identity");PROCEDURE LOADMATRIXD(M:GL.DOUBLEPTR);
...
PROCEDURE COLOR3B(RED_VALUE:GL.BYTE;GREEN_VALUE:GL.BYTE;BLUE_VALUE:GL.BYTE);PROCEDURE COLOR(RED_VALUE,GREEN_VALUE,BLUE_VALUE:GL.DOUBLE);
PROCEDURE COLOR_F(RED_VALUE,GREEN_VALUE,BLUE_VALUE:GL.FLOAT);PROCEDURE COLOR(RED_VALUE,GREEN_VALUE,BLUE_VALUE:GL.INT);PROCEDURE COLOR_S(RED_VALUE,GREEN_VALUE,BLUE_VALUE:GL.SHORT);
PROCEDURE COLOR3UB(RED_VALUE:GL.UBYTE;GREEN_VALUE:GL.UBYTE;BLUE_VALUE:GL.UBYTE);PROCEDURE COLOR3UI(RED_VALUE:GL.UINT;GREEN_VALUE:GL.UINT;
BLUE_VALUE:GL.UINT);PROCEDURE COLOR3US(RED_VALUE:GL.USHORT;GREEN_VALUE:GL.USHORT;BLUE_VALUE:GL.USHORT);PROCEDURE COLOR4B(RED_VALUE:GL.BYTE;
GREEN_VALUE:GL.BYTE;BLUE_VALUE:GL.BYTE;ALPHA_VALUE:GL.BYTE);PROCEDURE COLOR(RED_VALUE,GREEN_VALUE,BLUE_VALUE,ALPHA_VALUE:GL.DOUBLE);PROCEDURE COLOR_F(RED_VALUE,GREEN_VALUE,BLUE_VALUE,ALPHA_VALUE:GL.FLOAT);
PROCEDURE COLOR(RED_VALUE,GREEN_VALUE,BLUE_VALUE,ALPHA_VALUE:GL.INT);PROCEDURE COLOR_S(RED_VALUE,GREEN_VALUE,BLUE_VALUE,ALPHA_VALUE:GL.SHORT);
PROCEDURE COLOR4UB(RED_VALUE:GL.UBYTE;GREEN_VALUE:GL.UBYTE;BLUE_VALUE:GL.UBYTE;ALPHA_VALUE:GL.UBYTE);PROCEDURE COLOR4UI(RED_VALUE:GL.UINT;
GREEN_VALUE:GL.UINT;BLUE_VALUE:GL.UINT;ALPHA_VALUE:GL.UINT);PROCEDURE COLOR4US(RED_VALUE:GL.USHORT;GREEN_VALUE:GL.USHORT;BLUE_VALUE:GL.USHORT;
ALPHA_VALUE:GL.USHORT);PROCEDURE COLOR3BV(V:GL.BYTEPTR);PROCEDURE COLOR3DV(V:GL.DOUBLEPTR);PROCEDURE COLOR(V:RGB_COLOR);PROCEDURE COLOR3FV(V:GL.FLOATPTR);
PROCEDURE COLOR3IV(V:GL.INTPOINTER);PROCEDURE COLOR3SV(V:GL.SHORTPTR);PROCEDURE COLOR3UBV(V:GL.UBYTEPTR);PROCEDURE COLOR3UIV(V:GL.UINTPTR);
PROCEDURE COLOR3USV(V:GL.USHORTPTR);PROCEDURE COLOR4BV(V:GL.BYTEPTR);PROCEDURE COLOR4DV(V:GL.DOUBLEPTR);PROCEDURE COLOR(V:RGBA_COLOR);
PROCEDURE COLOR4FV(V:GL.FLOATPTR);PROCEDURE COLOR4IV(V:GL.INTPOINTER);PROCEDURE COLOR4SV(V:GL.SHORTPTR);PROCEDURE COLOR4UBV(V:GL.UBYTEPTR);
PROCEDURE COLOR4UIV(V:GL.UINTPTR);PROCEDURE COLOR4USV(V:GL.USHORTPTR);PROCEDURE TEXCOORD1D(S:GL.DOUBLE);PROCEDURE TEXCOORD1F(S:GL.FLOAT);
PROCEDURE TEXCOORD1I(S:GL.INT);PROCEDURE TEXCOORD1S(S:GL.SHORT);PROCEDURE TEXCOORD(S:GL.DOUBLE;T:GL.DOUBLE);PROCEDURE TEXCOORDF(S:GL.FLOAT;
T:GL.FLOAT);PROCEDURE TEXCOORD2I(S:GL.INT;T:GL.INT);PROCEDURE TEXCOORD2S(S:GL.SHORT;T:GL.SHORT);PROCEDURE TEXCOORD3D(S:GL.DOUBLE;T:GL.DOUBLE;
R:GL.DOUBLE);PROCEDURE TEXCOORD3F(S:GL.FLOAT;T:GL.FLOAT;R:GL.FLOAT);PROCEDURE TEXCOORD3I(S:GL.INT;T:GL.INT;R:GL.INT);PROCEDURE TEXCOORD3S(S:GL.SHORT;
...
PROCEDURE RESIZEBUFFERSMESA;PRIVATE FOR FACE_SELECTOR USE (FRONT=>16#0404#,BACK=>16#0405#,FRONT_AND_BACK=>16#0408#);FOR FACE_SELECTOR'SIZE USE GL.ENUM'SIZE;
FOR ORIENTATION USE (CLOCKWISE=>16#0900#,COUNTER_CLOCKWISE=>16#0901#);FOR ORIENTATION'SIZE USE GL.ENUM'SIZE;FOR POLYGON_MODE_TYPE USE (POINT=>16#1B00#,
LINE=>16#1B01#,FILL=>16#1B02#);FOR POLYGON_MODE_TYPE'SIZE USE GL.ENUM'SIZE;FOR SHADE_MODEL_TYPE USE (FLAT=>16#1D00#,SMOOTH=>16#1D01#);
FOR SHADE_MODEL_TYPE'SIZE USE GL.ENUM'SIZE;FUNCTION GLGETSTRING(NAME:STRINGENM)RETURN UBYTEPTR;FUNCTION GETSTRING(NAME:STRINGENM)RETURN UBYTEPTR RENAMES GLGETSTRING;
PROCEDURE COLOR3D(RED_VALUE,GREEN_VALUE,BLUE_VALUE:GL.DOUBLE);PROCEDURE COLOR(RED_VALUE,GREEN_VALUE,BLUE_VALUE:GL.DOUBLE)RENAMES COLOR3D;
PROCEDURE COLOR3F(RED_VALUE,GREEN_VALUE,BLUE_VALUE:GL.FLOAT);PROCEDURE COLOR_F(RED_VALUE,GREEN_VALUE,BLUE_VALUE:GL.FLOAT)RENAMES COLOR3F;
PROCEDURE COLOR3I(RED_VALUE,GREEN_VALUE,BLUE_VALUE:GL.INT);PROCEDURE COLOR(RED_VALUE,GREEN_VALUE,BLUE_VALUE:GL.INT)RENAMES COLOR3I;PROCEDURE COLOR3S(RED_VALUE,GREEN_VALUE,BLUE_VALUE:GL.SHORT);
PROCEDURE COLOR_S(RED_VALUE,GREEN_VALUE,BLUE_VALUE:GL.SHORT)RENAMES COLOR3S;PROCEDURE COLOR4D(RED_VALUE,GREEN_VALUE,BLUE_VALUE,ALPHA_VALUE:GL.DOUBLE);
PROCEDURE COLOR(RED_VALUE,GREEN_VALUE,BLUE_VALUE,ALPHA_VALUE:GL.DOUBLE)RENAMES COLOR4D;PROCEDURE COLOR4F(RED_VALUE,GREEN_VALUE,BLUE_VALUE,ALPHA_VALUE:GL.FLOAT);
PROCEDURE COLOR_F(RED_VALUE,GREEN_VALUE,BLUE_VALUE,ALPHA_VALUE:GL.FLOAT)RENAMES COLOR4F;PROCEDURE COLOR4I(RED_VALUE,GREEN_VALUE,BLUE_VALUE,ALPHA_VALUE:GL.INT);
PROCEDURE COLOR(RED_VALUE,GREEN_VALUE,BLUE_VALUE,ALPHA_VALUE:GL.INT)RENAMES COLOR4I;PROCEDURE COLOR4S(RED_VALUE,GREEN_VALUE,BLUE_VALUE,ALPHA_VALUE:GL.SHORT);
PROCEDURE COLOR_S(RED_VALUE,GREEN_VALUE,BLUE_VALUE,ALPHA_VALUE:GL.SHORT)RENAMES COLOR4S;PROCEDURE NORMAL3D(X,Y,Z:GL.DOUBLE);PROCEDURE NORMAL(X,Y,Z:GL.DOUBLE)RENAMES NORMAL3D;
PROCEDURE NORMAL3F(X,Y,Z:GL.FLOAT);PROCEDURE NORMAL_F(X,Y,Z:GL.FLOAT)RENAMES NORMAL3F;PROCEDURE NORMAL3I(X,Y,Z:GL.INT);PROCEDURE NORMAL(X,Y,Z:GL.INT)RENAMES NORMAL3I;
PROCEDURE NORMAL3B(X,Y,Z:GL.BYTE);PROCEDURE NORMAL_B(X,Y,Z:GL.BYTE)RENAMES NORMAL3B;PROCEDURE NORMAL3S(X,Y,Z:GL.SHORT);PROCEDURE NORMAL_S(X,Y,Z:GL.SHORT)RENAMES NORMAL3S;
PROCEDURE SCALE3D(X,Y,Z:GL.DOUBLE);PROCEDURE SCALE(X,Y,Z:GL.DOUBLE)RENAMES SCALE3D;PROCEDURE SCALE3F(X,Y,Z:GL.FLOAT);PROCEDURE SCALE_F(X,Y,Z:GL.FLOAT)RENAMES SCALE3F;
PROCEDURE TRANSLATE3D(X,Y,Z:GL.DOUBLE);PROCEDURE TRANSLATE(X,Y,Z:GL.DOUBLE)RENAMES TRANSLATE3D;PROCEDURE TRANSLATE3F(X,Y,Z:GL.FLOAT);PROCEDURE TRANSLATE_F(X,Y,Z:GL.FLOAT)RENAMES TRANSLATE3F;
...
PROCEDURE GETDOUBLEV(PNAME:PARAMETERNAMEENM;PARAMS:GL.DOUBLEPTR);PROCEDURE GET(PNAME:PARAMETERNAMEENM;PARAMS:GL.DOUBLEPTR)RENAMES GETDOUBLEV;
PROCEDURE LIGHTF(LIGHT_ID:LIGHTIDENM;PNAME:LIGHTPARAMETERENM;PARAM:GL.FLOAT);PROCEDURE LIGHT(LIGHT_ID:LIGHTIDENM;PNAME:LIGHTPARAMETERENM;
PARAM:GL.FLOAT)RENAMES LIGHTF;PROCEDURE LIGHTFV(LIGHT_ID:LIGHTIDENM;PNAME:LIGHTPARAMETERVENM;PARAMS:FLOATPTR);PROCEDURE MATERIALF(FACE:FACE_SELECTOR;
PNAME:MATERIALPARAMETERENM;PARAM:GL.FLOAT);PROCEDURE MATERIAL(FACE:FACE_SELECTOR;PNAME:MATERIALPARAMETERENM;PARAM:GL.FLOAT)RENAMES MATERIALF;
PROCEDURE MATERIALFV(FACE:FACE_SELECTOR;PNAME:MATERIALPARAMETERVENM;PARAMS:FLOATPTR);PROCEDURE PIXELSTOREI(PNAME:PIXELSTORAGEENM;PARAM:GL.INT);
...
PARAM:GL.INT);PROCEDURE TEXTURE_PARAMETER(TARGET:TARGETTEXENM;PNAME:TEXPARAMENM;PARAM:GL.INT)RENAMES TEXPARAMETERI;PROCEDURE GLACCUM(OP:ACCUMENM;
VALUE:GL.FLOAT);PROCEDURE ACCUM(OP:ACCUMENM;VALUE:GL.FLOAT)RENAMES GLACCUM;PROCEDURE GLCLEAR(MASK:BITFIELD);PROCEDURE CLEAR(MASK:BITFIELD)RENAMES GLCLEAR;
PROCEDURE GLVIEWPORT(X:GL.INT;Y:GL.INT;WIDTH:GL.SIZEI;HEIGHT:GL.SIZEI);PROCEDURE VIEWPORT(X:GL.INT;Y:GL.INT;WIDTH:GL.SIZEI;HEIGHT:GL.SIZEI)RENAMES GLVIEWPORT;
PRAGMA IMPORT(STDCALL,CLEARINDEX,"glClearIndex");PRAGMA IMPORT(STDCALL,CLEAR_COLOR,"glClearColor");PRAGMA IMPORT(STDCALL,GLCLEAR,"glClear");
PRAGMA IMPORT(STDCALL,INDEXMASK,"glIndexMask");PRAGMA IMPORT(STDCALL,COLORMASK,"glColorMask");PRAGMA IMPORT(STDCALL,ALPHAFUNC,"glAlphaFunc");
PRAGMA IMPORT(STDCALL,BLENDFUNC,"glBlendFunc");PRAGMA IMPORT(STDCALL,LOGICOP,"glLogicOp");PRAGMA IMPORT(STDCALL,SET_CULL_FACE,"glCullFace");
PRAGMA IMPORT(STDCALL,SET_FRONT_FACE,"glFrontFace");PRAGMA IMPORT(STDCALL,POINTSIZE,"glPointSize");PRAGMA IMPORT(STDCALL,LINEWIDTH,"glLineWidth");
PRAGMA IMPORT(STDCALL,LINESTIPPLE,"glLineStipple");PRAGMA IMPORT(STDCALL,SET_POLYGON_MODE,"glPolygonMode");PRAGMA IMPORT(STDCALL,POLYGONOFFSET,"glPolygonOffset");
PRAGMA IMPORT(STDCALL,POLYGONSTIPPLE,"glPolygonStipple");PRAGMA IMPORT(STDCALL,GETPOLYGONSTIPPLE,"glGetPolygonStipple");PRAGMA IMPORT(STDCALL,EDGEFLAG,"glEdgeFlag");
PRAGMA IMPORT(STDCALL,EDGEFLAGV,"glEdgeFlagv");PRAGMA IMPORT(STDCALL,SCISSOR,"glScissor");PRAGMA IMPORT(STDCALL,CLIPPLANE,"glClipPlane");
PRAGMA IMPORT(STDCALL,GETCLIPPLANE,"glGetClipPlane");PRAGMA IMPORT(STDCALL,DRAWBUFFER,"glDrawBuffer");PRAGMA IMPORT(STDCALL,READBUFFER,"glReadBuffer");
PRAGMA IMPORT(STDCALL,ENABLE,"glEnable");PRAGMA IMPORT(STDCALL,DISABLE,"glDisable");PRAGMA IMPORT(STDCALL,ISENABLED,"glIsEnabled");PRAGMA IMPORT(STDCALL,ENABLECLIENTSTATE,"glEnableClientState");
PRAGMA IMPORT(STDCALL,DISABLECLIENTSTATE,"glDisableClientState");PRAGMA IMPORT(STDCALL,GETBOOLEANV,"glGetBooleanv");PRAGMA IMPORT(STDCALL,GETDOUBLEV,"glGetDoublev");
PRAGMA IMPORT(STDCALL,GETFLOATV,"glGetFloatv");PRAGMA IMPORT(STDCALL,GETINTEGERV,"glGetIntegerv");PRAGMA IMPORT(STDCALL,PUSH_ATTRIB,"glPushAttrib");
PRAGMA IMPORT(STDCALL,POP_ATTRIB,"glPopAttrib");PRAGMA IMPORT(STDCALL,PUSHCLIENTATTRIB,"glPushClientAttrib");PRAGMA IMPORT(STDCALL,POPCLIENTATTRIB,"glPopClientAttrib");
PRAGMA IMPORT(STDCALL,RENDERMODE,"glRenderMode");PRAGMA IMPORT(STDCALL,GETERROR,"glGetError");PRAGMA IMPORT(STDCALL,GLGETSTRING,"glGetString");
PRAGMA IMPORT(STDCALL,FINISH,"glFinish");PRAGMA IMPORT(STDCALL,FLUSH,"glFlush");PRAGMA IMPORT(STDCALL,HINT,"glHint");PRAGMA IMPORT(STDCALL,CLEARDEPTH,"glClearDepth");
PRAGMA IMPORT(STDCALL,DEPTHFUNC,"glDepthFunc");PRAGMA IMPORT(STDCALL,DEPTHMASK,"glDepthMask");PRAGMA IMPORT(STDCALL,DEPTHRANGE,"glDepthRange");
PRAGMA IMPORT(STDCALL,CLEAR_ACCUMULATION_BUFFER,"glClearAccum");PRAGMA IMPORT(STDCALL,GLACCUM,"glAccum");PRAGMA IMPORT(STDCALL,SET_MATRIX_MODE,"glMatrixMode");
PRAGMA IMPORT(STDCALL,ORTHO,"glOrtho");PRAGMA IMPORT(STDCALL,FRUSTUM,"glFrustum");PRAGMA IMPORT(STDCALL,GLVIEWPORT,"glViewport");PRAGMA IMPORT(STDCALL,PUSH_MATRIX,"glPushMatrix");
PRAGMA IMPORT(STDCALL,POP_MATRIX,"glPopMatrix");PRAGMA IMPORT(STDCALL,LOAD_IDENTITY,"glLoadIdentity");PRAGMA IMPORT(STDCALL,LOADMATRIXD,"glLoadMatrixd");
PRAGMA IMPORT(STDCALL,LOADMATRIXF,"glLoadMatrixf");PRAGMA IMPORT(STDCALL,MULTMATRIXD,"glMultMatrixd");PRAGMA IMPORT(STDCALL,MULTMATRIXF,"glMultMatrixf");
PRAGMA IMPORT(STDCALL,ROTATED,"glRotated");PRAGMA IMPORT(STDCALL,ROTATEF,"glRotatef");PRAGMA IMPORT(STDCALL,SCALE3D,"glScaled");PRAGMA IMPORT(STDCALL,SCALE3F,"glScalef");
PRAGMA IMPORT(STDCALL,TRANSLATE3D,"glTranslated");PRAGMA IMPORT(STDCALL,TRANSLATE3F,"glTranslatef");PRAGMA IMPORT(STDCALL,ISLIST,"glIsList");
PRAGMA IMPORT(STDCALL,DELETE_LISTS,"glDeleteLists");PRAGMA IMPORT(STDCALL,GEN_LISTS,"glGenLists");PRAGMA IMPORT(STDCALL,NEW_LIST,"glNewList");
PRAGMA IMPORT(STDCALL,END_LIST,"glEndList");PRAGMA IMPORT(STDCALL,CALL_LIST,"glCallList");PRAGMA IMPORT(STDCALL,CALLLISTS,"glCallLists");
...
PRAGMA IMPORT(STDCALL,INTERLEAVEDARRAYS,"glInterleavedArrays");PRAGMA IMPORT(STDCALL,SET_SHADE_MODEL,"glShadeModel");PRAGMA IMPORT(STDCALL,LIGHTF,"glLightf");
...
PRAGMA IMPORT(STDCALL,BIND_TEXTURE,"glBindTexture");PRAGMA IMPORT(STDCALL,PRIORITIZETEXTURES,"glPrioritizeTextures");PRAGMA IMPORT(STDCALL,ARETEXTURESRESIDENT,"glAreTexturesResident");
...
PRAGMA IMPORT(STDCALL,WINDOWPOS4DVMESA,"glWindowPos4dvMESA");PRAGMA IMPORT(STDCALL,RESIZEBUFFERSMESA,"glResizeBuffersMESA");END GL;
