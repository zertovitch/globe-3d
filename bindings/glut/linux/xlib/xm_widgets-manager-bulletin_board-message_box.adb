...
with Ada.Unchecked_Conversion,
     Interfaces.C,
     X_Toolkit.Internal;
package body Xm_Widgets.Manager.Bulletin_Board.Message_Box is


   function Xm_Is_Message_Box (W: in Widget) return Boolean is
   begin
      return Xt_Is_Subclass (W, Xm_Message_Box_Widget_Class);
   ...
   begin
      return XmCreateMessageBox (Parent,
                                 Name_String'Address,
   ...
   function Xm_Create_Message_Dialog
     (Parent   : in  Widget; 
      ...
      function XmCreateMessageDialog
        (Parent : in Widget;
         Name   : in System.Address;
         Args   : in X_Toolkit.Internal.Arg_Rec_Access;
         Count  : in Cardinal)
      ...
      Name_String : constant Interfaces.C.Char_Array
                  := Interfaces.C.To_C (Name, Append_Nul => True);
   begin
      return XmCreateMessageDialog (Parent,
                                    Name_String'Address,
                                    X_Toolkit.Internal.Hook (Arglist),
                                    Cardinal (Length (Arglist)));
   ...
   function Xm_Create_Error_Dialog
     (Parent   : in  Widget;
      ...
      Name_String : constant Interfaces.C.Char_Array
                  := Interfaces.C.To_C (Name, Append_Nul => True);
   begin
      return XmCreateErrorDialog (Parent,
                                  Name_String'Address,
                                  X_Toolkit.Internal.Hook (Arglist),
                                  Cardinal (Length (Arglist)));
   ...
   function Xm_Create_Information_Dialog
     (Parent   : in  Widget;
      ...
      function XmCreateInformationDialog
        (Parent : in Widget;
         Name   : in System.Address;
         Args   : in X_Toolkit.Internal.Arg_Rec_Access;
         Count  : in Cardinal)
         return Widget;
      pragma Import (C, XmCreateInformationDialog, "XmCreateInformationDialog");
   ...
   function Xm_Create_Question_Dialog
     (Parent   : in  Widget;
      ...
      function XmCreateQuestionDialog
        (Parent : in Widget;
         Name   : in System.Address;
         Args   : in X_Toolkit.Internal.Arg_Rec_Access;
         Count  : in Cardinal)
   ...
   function Xm_Create_Warning_Dialog
     (Parent   : in  Widget;
      ...
      function XmCreateWarningDialog
        (Parent : in Widget;
         Name   : in System.Address;
         Args   : in X_Toolkit.Internal.Arg_Rec_Access;
         Count  : in Cardinal)
      ...
      Name_String : constant Interfaces.C.Char_Array
                  := Interfaces.C.To_C (Name, Append_Nul => True);
   begin
      return XmCreateWarningDialog (Parent,
                                    Name_String'Address,
                                    X_Toolkit.Internal.Hook (Arglist),
                                    Cardinal (Length (Arglist)));
   ...
   function Xm_Create_Working_Dialog
     (Parent   : in  Widget;
      ...
      function XmCreateWorkingDialog
        (Parent : in Widget;
         Name   : in System.Address;
         Args   : in X_Toolkit.Internal.Arg_Rec_Access;
         Count  : in Cardinal)
      ...
      Name_String : constant Interfaces.C.Char_Array
                  := Interfaces.C.To_C (Name, Append_Nul => True);
   begin
      return XmCreateWorkingDialog (Parent,
                                    Name_String'Address,
                                    X_Toolkit.Internal.Hook (Arglist),
                                    Cardinal (Length (Arglist)));
   ...
   function Xm_Create_Template_Dialog
     (Parent   : in  Widget;
      ...
      function XmCreateTemplateDialog
        (Parent : in Widget;
         Name   : in System.Address;
         Args   : in X_Toolkit.Internal.Arg_Rec_Access;
         Count  : in Cardinal)
   ...
   function To_Integer is
      new Ada.Unchecked_Conversion (Default_Button_Type, Interfaces.C.unsigned_char);

   procedure Append_Set (List  : in out Arg_List;
                         Name  : in     Xt_N_Resource_String;
                         Value : in     Default_Button_Type) is
   begin
   ...
   procedure Append_Get (List  : in out Arg_List;
                         Name  : in     Xt_N_Resource_String;
                         Value :    out Default_Button_Type) is
   begin
      Append_Set (List => List,
                  Name => Name,
                  Value => Value'Address);
   ...
   function To_Integer is
      new Ada.Unchecked_Conversion (Dialog_Type, Interfaces.C.unsigned_char);

   procedure Append_Set (List  : in out Arg_List;
                         Name  : in     Xt_N_Resource_String;
                         Value : in     Dialog_Type) is
   begin
      Append_Set (List => List,
                  Name => Name,
                  Value => Integer (To_Integer (Value)));
