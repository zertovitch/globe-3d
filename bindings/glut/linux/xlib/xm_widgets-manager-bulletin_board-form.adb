...
with Ada.Unchecked_Conversion,
     Interfaces.C,
     X_Toolkit.Internal;
package body Xm_Widgets.Manager.Bulletin_Board.Form is


   function Xm_Is_Form (W: in Widget) return Boolean is
   begin
      return Xt_Is_Subclass (W, Xm_Form_Widget_Class);
   end Xm_Is_Form;
   ...
   function Xm_Create_Form_Dialog
     (Parent   : in  Widget; 
      ...
      Name_String : constant Interfaces.C.Char_Array
                  := Interfaces.C.To_C (Name, Append_Nul => True);
   begin
      return XmCreateFormDialog (Parent,
                           Name_String'Address,
                           X_Toolkit.Internal.Hook (Arglist),
                           Cardinal (Length (Arglist)));
