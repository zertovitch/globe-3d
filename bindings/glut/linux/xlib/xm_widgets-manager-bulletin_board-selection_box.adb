...
with Ada.Unchecked_Conversion,
     Interfaces.C,
     X_Toolkit.Internal;
package body Xm_Widgets.Manager.Bulletin_Board.Selection_Box is


   function To_Callback_Struct (Pointer : in Xt_Pointer)
      return Xm_Selection_Box_Callback_Struct_Access is
      function To_CS is
         new To_Generic_Callback_Struct_Access (Xm_Selection_Box_Callback_Struct,
             Xm_Selection_Box_Callback_Struct_Access,
             Callback_Reason_Array_Type'(1 => Cr_Help, 2 => Cr_OK,
	                                 3 => Cr_Cancel, 4 => Cr_Apply,
					 5 => Cr_No_Match));
   begin
   ...
   function Xm_Is_Selection_Box (W : in Widget) return Boolean is
   begin
      return Xt_Is_Subclass (W, Xm_Selection_Box_Widget_Class);
   ...
   begin
      return XmCreateSelectionBox (Parent,
                                   Name_String'Address,
   ...
   function Xm_Create_Selection_Dialog
     (Parent   : in  Widget;
      ...
      function XmCreateSelectionDialog
        (Parent : in Widget;
         Name   : in System.Address;
         Args   : in X_Toolkit.Internal.Arg_Rec_Access;
         Count  : in Cardinal)
   ...
   function Xm_Create_Prompt_Dialog
     (Parent   : in  Widget;
      ...
      Name_String : constant Interfaces.C.Char_Array
                  := Interfaces.C.To_C (Name, Append_Nul => True);
   begin
      return XmCreatePromptDialog (Parent,
                                   Name_String'Address,
                                   X_Toolkit.Internal.Hook (Arglist),
                                   Cardinal (Length (Arglist)));
   ...
   function To_Integer is
      new Ada.Unchecked_Conversion (Child_Placement_Type, Interfaces.C.unsigned_char);

   procedure Append_Set (List  : in out Arg_List;
                         Name  : in     Xt_N_Resource_String;
                         Value : in     Child_Placement_Type) is
   begin
   ...
   procedure Append_Get (List  : in out Arg_List;
                         Name  : in     Xt_N_Resource_String;
                         Value :    out Child_Placement_Type) is
   begin
      Append_Set (List => List,
                  Name => Name,
                  Value => Value'Address);
