...
with Ada.Unchecked_Conversion,
     Interfaces.C,
     X_Toolkit.Internal;
package body Xm_Widgets.Manager.Scrolled_Window.Main_Window is

   function Xm_Is_Main_Window (W : in Widget) return Boolean is
   begin
      return Xt_Is_Subclass (W, Xm_Main_Window_Widget_Class);
   ...
   begin
      return XmCreateMainWindow (Parent,
                                 Name_String'Address,
   ...
   function To_Integer is
      new Ada.Unchecked_Conversion (Command_Window_Location_Type, Interfaces.C.unsigned_char);

   procedure Append_Set (List  : in out Arg_List;
                         Name  : in     Xt_N_Resource_String;
                         Value : in     Command_Window_Location_Type) is
   begin
   ...
   procedure Append_Get (List  : in out Arg_List;
                         Name  : in     Xt_N_Resource_String;
                         Value :    out Command_Window_Location_Type) is
   begin
      Append_Set (List => List,
                  Name => Name,
                  Value => Value'Address);
