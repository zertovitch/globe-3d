...
with Ada.Unchecked_Conversion,
     Interfaces.C,
     X_Toolkit.Internal;
package body Xm_Widgets.Manager.Scale is


   function To_Callback_Struct (Pointer : in Xt_Pointer)
      return Xm_Scale_Callback_Struct_Access is
      function To_CS is
         new To_Generic_Callback_Struct_Access (Xm_Scale_Callback_Struct,
   ...
   function Xm_Is_Scale (W : in Widget) return Boolean is
   begin
      return Xt_Is_Subclass (W, Xm_Scale_Widget_Class);
   end Xm_Is_Scale;
   ...
   procedure Xm_Scale_Get_Value (W     : in  Widget;
      ...
      procedure XmScaleGetValue (W     : in  Widget;
                                 Value : in  System.Address);
      pragma Import (C, XmScaleGetValue, "XmScaleGetValue");
   begin
      XmScaleGetValue (W, Value'Address);
   end Xm_Scale_Get_Value;


   function To_Integer is
      new Ada.Unchecked_Conversion (Show_Value_Type, Interfaces.C.unsigned_char);

   procedure Append_Set (List  : in out Arg_List;
                         Name  : in     Xt_N_Resource_String;
                         Value : in     Show_Value_Type) is
   begin
