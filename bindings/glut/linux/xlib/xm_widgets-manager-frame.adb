...
with Ada.Unchecked_Conversion,
     Interfaces.C,
     X_Toolkit.Internal;
package body Xm_Widgets.Manager.Frame is


   function Xm_Is_Frame (W : in Widget) return Boolean is
   begin
      return Xt_Is_Subclass (W, Xm_Frame_Widget_Class);
   end Xm_Is_Frame;
...
-- UseMotif2.0 Motif2.1
   ...
   procedure Append_Set (List  : in out Arg_List;
                         Name  : in     Xt_N_Resource_String;
                         Value : in     Vertical_Alignment) is
   begin
      Append_Set (List   => List,
                  Name   => Name,
                  Value  => Integer (To_Integer (Value)));
   ...
   procedure Append_Get (List  : in out Arg_List;
                         Name  : in     Xt_N_Resource_String;
                         Value :    out Vertical_Alignment) is
   begin
      Append_Set (List   => List,
                  Name   => Name,
                  Value  => Value'Address);
...
-- EndMotif2.0 Motif2.1
   ...
   function To_Integer is
      new Ada.Unchecked_Conversion (Frame_Child_Type, Interfaces.C.unsigned_char);

   procedure Append_Set (List  : in out Arg_List;
                         Name  : in     Xt_N_Resource_String;
                         Value : in     Frame_Child_Type) is
   begin
      Append_Set (List   => List,
                  Name   => Name,
                  Value  => Integer (To_Integer (Value)));
