...
with Ada.Unchecked_Conversion,
     Interfaces.C,
     X_Toolkit.Internal;
package body Xm_Widgets.Drag_Icon is

   -- -------------------------------------------------------------------------
   --
   -- XmIsDragIconObject
   --
   function Xm_Is_Drag_Icon_Object_Class (W : in Widget) return Boolean is
   begin
      return Xt_Is_Subclass (W, Xm_Drag_Icon_Object_Class);
