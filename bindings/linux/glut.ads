...
--
-- CAUTION: this GLUT.ads file is generated from preprocessing GLUT.prs
...
package GLUT is
   ...
   -- GLUT API Extension definitions 
   ...
   -- for sharing GL rendering contexts.
   --
   GLUT_RENDERING_CONTEXT   : constant := 16#01FD#;       -- for 'Get' and 'SetOption' parameter.  
