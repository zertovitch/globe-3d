...
-- UseMotif2.0 Motif2.1
   ...
   begin
      return Xt_Is_Subclass (W, Xm_Icon_Gadget_Class);
   end Xm_Is_Icon_Gadget;


   function Xm_Create_Icon_Gadget (Parent   : in  Widget; 
                                   Name     : in  String;
                                   Arglist  : in  Arg_List := Null_Arg_List)
                                   return Widget is
      function XmCreateIconGadget
        (Parent : in Widget;
   ...
   begin
      return XmCreateIconGadget (Parent,
                                 Name_String'Address,
   ...
   function To_Integer is
      new Ada.Unchecked_Conversion (View_Type, Interfaces.C.unsigned_char);
   ...
   function To_Integer is
      new Ada.Unchecked_Conversion (Visual_Emphasis_Type, Interfaces.C.unsigned_char);

   procedure Append_Set (List  : in out Arg_List;
                         Name  : in     Xt_N_Resource_String;
                         Value : in     Visual_Emphasis_Type) is
   begin
      Append_Set (List, Name, Integer (To_Integer (Value)));
   end Append_Set;
   pragma Inline (Append_Set);
   ...
   procedure Append_Get (List  : in out Arg_List;
                         Name  : in     Xt_N_Resource_String;
                         Value :    out Visual_Emphasis_Type) is
   begin
      Append_Set (List,
                  Name,
                  Value'Address);
