...
with Interfaces.C,
     X_Toolkit.Internal;
package body Xm_Widgets.Manager.Bulletin_Board.Selection_Box.Command is


   function Xm_Is_Command (W: in Widget) return Boolean is
   begin
      return Xt_Is_Subclass (W, Xm_Command_Widget_Class);
   end Xm_Is_Command;
   ...
   function To_Callback_Struct (Pointer : in Xt_Pointer)
      return Xm_Command_Callback_Struct_Access is
      function To_CS is
         new To_Generic_Callback_Struct_Access (Xm_Command_Callback_Struct,
             Xm_Command_Callback_Struct_Access,
             Callback_Reason_Array_type'(1 => Cr_Command_Entered));
   begin
   ...
   function Xm_Create_Command_Dialog
     (Parent   : in  Widget;
      ...
      function XmCreateCommandDialog
        (Parent : in Widget;
         Name   : in System.Address;
         Args   : in X_Toolkit.Internal.Arg_Rec_Access;
         Count  : in Cardinal)
         return Widget;
      pragma Import (C, XmCreateCommandDialog, "XmCreateCommandDialog");

      Name_String : constant Interfaces.C.Char_Array
                  := Interfaces.C.To_C (Name, Append_Nul => True);
   begin
      return XmCreateCommandDialog (Parent,
                                    Name_String'Address,
                                    X_Toolkit.Internal.Hook (Arglist),
                                    Cardinal (Length (Arglist)));
   end Xm_Create_Command_Dialog;
