...
with Ada.Unchecked_Conversion,
     Interfaces.C,
     X_Toolkit.Internal;
package body Xm_Widgets.Manager.Bulletin_Board.Selection_Box.File_Selection_Box is

   function To_Callback_Struct (Pointer : in Xt_Pointer)
      return Xm_File_Selection_Box_Callback_Struct_Access is
      function To_CS is
         new To_Generic_Callback_Struct_Access (Xm_File_Selection_Box_Callback_Struct,
             Xm_File_Selection_Box_Callback_Struct_Access,
             Callback_Reason_Array_Type'(1 => Cr_Help,   2 => Cr_OK,
	                                 3 => Cr_Cancel, 4 => Cr_No_Match));
   begin
   ...
   function Xm_Is_File_Selection_Box (W: in Widget) return Boolean is
   begin
      return Xt_Is_Subclass (W, Xm_File_Selection_Box_Widget_Class);
   ...
   function Xm_Create_File_Selection_Box
     (Parent   : in  Widget;
      ...
      function XmCreateFileSelectionBox
        (Parent : in Widget;
   ...
   function Xm_Create_File_Selection_Dialog
     (Parent   : in  Widget;
      ...
      function XmCreateFileSelectionDialog
        (Parent : in Widget;
         Name   : in System.Address;
         Args   : in X_Toolkit.Internal.Arg_Rec_Access;
         Count  : in Cardinal) return Widget;

      pragma Import (C, XmCreateFileSelectionDialog, "XmCreateFileSelectionDialog");
   ...
   function To_Integer is
      new Ada.Unchecked_Conversion (Xm_Search_Proc, Integer);

   procedure Append_Set (List  : in out Arg_List;
                         Name  : in     Xt_N_Resource_String;
                         Value : in     Xm_Search_Proc) is
   begin
...
-- UseMotif2.0 Motif2.1
   ...
   procedure Append_Get (List  : in out Arg_List;
                         Name  : in     Xt_N_Resource_String;
                         Value :    out Filter_Style_Type) is
   begin
      Append_Set (List => List,
                  Name => Name,
                  Value => Value'Address);
...
-- EndMotif2.0 Motif2.1
   ...
   function To_Integer is
      new Ada.Unchecked_Conversion (File_Type_Mask, Interfaces.C.unsigned_char);

   procedure Append_Set (List  : in out Arg_List;
                         Name  : in     Xt_N_Resource_String;
                         Value : in     File_Type_Mask) is
   begin
      Append_Set (List => List,
                  Name => Name,
                  Value => Integer (To_Integer (Value)));
