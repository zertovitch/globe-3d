...
with Interfaces.C,
     X_Toolkit.Internal;
package body Xm_Widgets.Manager.Drawing_Area is
 

   function To_Callback_Struct (Pointer : in Xt_Pointer)
      return Xm_Drawing_Area_Callback_Struct_Access is
      function To_CS is
         new To_Generic_Callback_Struct_Access (Xm_Drawing_Area_Callback_Struct,
            Xm_Drawing_Area_Callback_Struct_Access,
            Callback_Reason_Array_Type'(1 => Cr_Expose,
	                                2 => Cr_Resize,
					3 => Cr_Input));
   begin
   ...
   function Xm_Is_Drawing_Area (W : in Widget) return Boolean is
   begin
      return Xt_Is_Subclass (W, Xm_Drawing_Area_Widget_Class);
   ...
   begin
      return XmCreateDrawingArea (Parent,
                                  Name_String'Address,
