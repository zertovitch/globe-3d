...
gprbuild -P culler/armada/armada.gpr           -d -XG3D_OS=linux -XBuild_Mode=fast
gprbuild -P culler/terrain_vbo/terrain_vbo.gpr -d -XG3D_OS=linux -XBuild_Mode=fast
gprbuild -P multi_window/multi_window.gpr      -d -XG3D_OS=linux -XBuild_Mode=fast
gprbuild -P sprite/sprite_demo.gpr             -d -XG3D_OS=linux -XBuild_Mode=fast
