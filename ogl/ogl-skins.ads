...
with ogl.Geometry, ogl.Textures, ogl.Materials;
with ogl.Buffer.texture_coords;
with ogl.Buffer.normals;



package ogl.Skins is
   ...
   function  new_Veneer (Self : in     Skin;   for_Geometry : in ogl.Geometry.Geometry'Class) return p_Veneer   is abstract;
   ...
   function  new_Veneer     (Self : in     Skin_opaque_unlit_mono_color;   for_Geometry : in ogl.Geometry.Geometry'Class) return p_Veneer;
   ...
   type Veneer_opaque_lit_mono_color (max_Normals : ogl.geometry.vertex_Id) is new Veneer with
      record
         Normals : ogl.geometry.Normal_array (1 .. max_Normals);
      end record;
   ...
   type Skin_opaque_lit_mono_color is new Skin with
      record
         Material : ogl.materials.Material_type := materials.neutral_material;
      end record;

   function  new_Veneer (Self : in     Skin_opaque_lit_mono_color;   for_Geometry : in ogl.Geometry.Geometry'Class) return p_Veneer;
   ...
   type Veneer_transparent_unlit_textured (num_Coordinates : ogl.geometry.vertex_Id) is new Veneer with
      record
         texture_Coordinates : ogl.textures.Coordinate_2D_array (1 .. num_Coordinates);
      end record;
   ...
   type Skin_transparent_unlit_textured is new Skin with
      record
         Texture              : ogl.Textures.Object;
         coordinate_Generator : ogl.textures.p_coordinate_Generator;
      end record;
   ...
   function  new_Veneer     (Self : in     Skin_transparent_unlit_textured;   for_Geometry : in ogl.Geometry.Geometry'Class) return p_Veneer;
   ...
   type Veneer_unlit_textured_vbo is new Veneer with
      record
         ...
         texture_Coordinates : ogl.Buffer.texture_coords.Object;
      end record;
   ...
   function  new_Veneer (Self : in     Skin_unlit_textured_vbo;   for_Geometry : in ogl.Geometry.Geometry'Class) return p_Veneer;
   ...
   green_Skin     : p_Skin := new ogl.skins.Skin_opaque_unlit_mono_color'(color => (red   => 1.0,
                                                                                   green => 1.0,
                                                                                   blue  => 1.0));

   lit_green_Skin : p_Skin := new ogl.skins.Skin_opaque_lit_mono_color;  -- tbd: set to a green colour (defaults to neutral grey atm :)
