...
package ogl.Textures is
   ...
   type   Coordinate_2D_array is array (ogl.geometry.positive_vertex_Id range <>) of aliased Coordinate_2D;   -- tbd: can the index be '1'-based ?
   ...
   function to_texture_Coordinates_xz (the_Points  : in ogl.geometry.vertex_Array;
   ...
   function to_Coordinates (Self : in coordinate_Generator;   the_Vertices : in ogl.geometry.Vertex_array) return ogl.textures.p_Coordinate_2D_array is abstract;
   function to_Coordinates (Self : in coordinate_Generator;   the_Vertices : in ogl.geometry.Vertex_array) return ogl.textures.Coordinate_2D_array is abstract;
   ...
   function to_Coordinates (Self : in xz_Generator;   the_Vertices : in ogl.geometry.Vertex_array) return ogl.textures.p_Coordinate_2D_array;
   function to_Coordinates (Self : in xz_Generator;   the_Vertices : in ogl.geometry.Vertex_array) return ogl.textures.Coordinate_2D_array;
