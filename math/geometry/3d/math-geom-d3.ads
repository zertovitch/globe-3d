...
package math.Geom.d3 is
   ...
   subtype Vertex is math.Numbers_3;
   ...
   type Triangle  is array (Positive range 1 .. 3) of math.geom.d3.Vertex;
   ...
   type Model (vertex_Count   : Positive;
      ...
      record
         Vertices  : d3.Vertices     (1 .. vertex_Count);
...
--     -- returns a mesh model from the Factory, based on any triangles already added, with vertices constrained to the given detail_Radius.
   ...
   function Volume_of              (Self : access Item) return Number    is abstract;
