...
package body GLOBE_3D.Impostor is
   ...
   begin
      ...
      o.Quads.all.set_vertex_Id (1, 1,  1);      -- todo: the '.all' required for gnat gpl06 ... not required in gpl07.
   ...
   is
      ...
      target_Centre_norm       : constant Vector_3D    := (target_Centre_proj (0)     / target_Centre_proj (3),
      ...
      target_Centre_norm_0to1  : constant Vector_3D    := (target_Centre_norm (0)     * 0.5 + 0.5,
                                                           target_Centre_norm (1)     * 0.5 + 0.5,
                                                           target_Centre_norm (2)     * 0.5 + 0.5);
      target_Lower_Left_norm_0to1 : constant Vector_3D := (target_Lower_Left_norm (0) * 0.5 + 0.5,
   ...
   begin
      o.prior_pixel_Region    := (o.current_copy_X,       o.current_copy_Y,
                                  o.current_Width_pixels, o.current_Height_pixels);
      ...
      then
         ...
         o.Skin.all.Texture := new_Texture (texture_Pool,  Natural (texture_Width),
   ...
   pragma Unreferenced (o);
   begin
      return True;   -- todo: - if using gl alpha test, depth sorting is not needed apparently.
