...
package body GL.Textures is
   ...
   begin
      ...
      GL.Bind_Texture (GL.Texture_2D, Self.Name);
   end enable;
   ...
   begin
      ...
      if unused_texture_List.Last > 0 then -- An existing unused texture has been found.
         ...
         Texture_Parameter (Texture_2D, TEXTURE_WRAP_S, CLAMP_TO_EDGE);       --      make them user settable !
         Texture_Parameter (Texture_2D, TEXTURE_WRAP_T, CLAMP_TO_EDGE);
